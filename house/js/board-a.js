  ...
  var LABEL = { agentic: "Claude", individual: "Individual", auto_grok: "Auto-Grok", joint: "Joint", combined: "House" };
  ...
  var JOBS = [
    { t: "06:30", days: [1, 2, 3, 4, 5], name: "Policy Pack", who: "Claude", role: "Full pack. World + WH. No trading." },
    { t: "09:30", days: [1], name: "Desk UX", who: "Claude", role: "Weekly phone-desk pass." },
    { t: "09:50", days: [1, 2, 3, 4, 5], name: "Autopilot AM", who: "Claude", role: "Name pick. Emails Grok to place." },
    { t: "10:00", days: [1], name: "Scorecard", who: "Claude", role: "Weekly process KEEP/CHANGE." },
    { t: "10:00", days: [1, 2, 3, 4, 5], name: "Snapshot", who: "Grok", role: "Book dump + mechanical stops." },
    { t: "11:50", days: [1, 2, 3, 4, 5], name: "Eyes", who: "Claude", role: "Risk-first pick. Quiet if \u226580% in." },
    { t: "13:50", days: [1, 2, 3, 4, 5], name: "Eyes", who: "Claude", role: "Risk-first pick. Quiet if \u226580% in." },
    { t: "14:50", days: [1, 2, 3, 4, 5], name: "Autopilot PM", who: "Claude", role: "Last same-day pick." },
    ...
    { t: "on SELL", days: [], name: "Process review", who: "Claude", role: "KEEP/CHANGE on the next pick." }
  ];
  var CAL = [
